...
namespace CPI311.GameEngine
{
    public class GameObject
    {
        ...
        public void Add<T>(T component) where T : Component
        {
            ...
            if (component is IUpdateable) Updateables.Add(component as
            IUpdateable);
            if (component is IRenderable) Renderables.Add(component as
            IRenderable);
        ...
        {
            if (Components.ContainsKey(typeof(T))) return Components[typeof(T)] as
            T;
            else return null;
        }
        ...
        public virtual void Update() // *** Assignment3 Update
                                     //public void Update()
        {
