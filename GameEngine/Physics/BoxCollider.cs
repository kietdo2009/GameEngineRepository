                ...
                for (int i = 0; i < 6; i++)
                {
                    for (int j = 0; j < 2; j++)
                    {
                        ...
                        if (d < collider.Radius)
                        {
                            ...
                            float area1 = Vector3.Dot(Vector3.Cross(b - a, q - a), n); // check if the point is inside of triangle
                            float area2 = Vector3.Dot(Vector3.Cross(c - b, q - b), n);
                            float area3 = Vector3.Dot(Vector3.Cross(a - c, q - c), n);
